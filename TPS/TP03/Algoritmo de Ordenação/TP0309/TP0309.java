...
class Mergesort{
     ...
     * @param array
     */
    public Mergesort(int tam, Filme[] array){
        this.array = array;
        this.tam = tam;
        this.compara = 0;
    }
    ...
    private void intercalar(int esq, int meio, int dir){
        ...
        Filme[] a1 = new Filme[num1 + 1];
        Filme[] a2 = new Filme[num2 + 1];
        ...
        for(i = j = 0, k = esq; k <= dir; k++){
            array[k] = (a1[i].getOrcamento() <= a2[j].getOrcamento()) ? a1[i++].clonar() : a2[j++].clonar();
        }
    }
}
...
public class TP0309{
    ...
    public static void log(double tempo, int compara){
        Arq.openWrite("689172_merge.txt");
    ...
    */
    public static void main (String[] args) throws Exception{
        ...
        Mergesort merge = new Mergesort(count, f);
        f = merge.sort();
