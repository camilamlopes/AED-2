...
class Insertion{
     ...
     * @param array
     */
    public Insertion(int tam, Filme[] array){
        this.array = array;
        this.tam = tam;
        this.compara = 0;
    }
    ...
    public Filme[] sort(){
        for (int i = 1; i < tam; i++){
            ...
            int j = i - 1;
            while ((j >= 0) && (array[j].getDataLancamento()).compareTo(tmp.getDataLancamento()) > 0){
...
public class TP0303{
    ...
    public static void log(double tempo, int compara){
        Arq.openWrite("689172_insercao.txt");
    ...
    */
    public static void main (String[] args) throws Exception{
        ...
        Insertion insert = new Insertion(count, f);
        f = insert.sort();
