...
class Heapsort{
     ...
     * @param array
     */
    public Heapsort(int tam, Filme[] array){
        this.array = array;
        this.tam = tam;
        this.compara = 0;
    }
...
public class TP0305{
    ...
    public static void log(double tempo, int compara){
        Arq.openWrite("689172_heapsort.txt");
    ...
    */
    public static void main (String[] args) throws Exception{
        ...
        Heapsort heap = new Heapsort(count, f);
        f = heap.sort();
