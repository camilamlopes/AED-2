...
class Lista{
    ...
    /**
     * Construtor da classe que cria uma lista sem elementos (somente cabeça)
     */
    public Lista (){
        this.primeiro = new Aloca();
        ultimo = primeiro;
    }
    ...
    public int tamanho() {
        int tam = 0;
        for(Aloca i = primeiro; i != ultimo; i = i.prox, tam++);
        return tam;
    }
}
